...
static void ImGui_ImplSDLGpu_CreateShaderModules(SDL_GpuDevice *device) {
    ...
    if (!bd->VertexShader || !bd->FragmentShader) {
        ...
        vertexShaderInfo.samplerCount = 0;
        vertexShaderInfo.storageTextureCount = 0;
        vertexShaderInfo.storageBufferCount = 0;
        vertexShaderInfo.uniformBufferCount = 1;

        fragmentShaderInfo.samplerCount = 1;
        fragmentShaderInfo.storageTextureCount = 0;
        fragmentShaderInfo.storageBufferCount = 0;
        fragmentShaderInfo.uniformBufferCount = 0;
